...
const RechercherSearch = ({inputValue}) => {
    console.log(inputValue);
    const [style, setStyle] = useState({ color: 'black' })
    const { isLoading, data, error } = useFetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${inputValue}`)
    return ( 
        <div className="RecupererSearch">
            {isLoading && <div style={{ textAlign: 'center' }}>votre recherche est en cour de traitement....</div>}
...
export default RechercherSearch;